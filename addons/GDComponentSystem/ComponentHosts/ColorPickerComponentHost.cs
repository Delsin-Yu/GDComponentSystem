...
[Tool, GlobalClass]
public partial class ColorPickerComponentHost : ColorPicker, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ColorPickerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ColorPickerComponentHost hostInstance);

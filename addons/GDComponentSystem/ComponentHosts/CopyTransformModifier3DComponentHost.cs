...
[Tool, GlobalClass]
public partial class CopyTransformModifier3DComponentHost : CopyTransformModifier3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CopyTransformModifier3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CopyTransformModifier3DComponentHost hostInstance);

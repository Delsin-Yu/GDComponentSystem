...
[Tool, GlobalClass]
public partial class CollisionShape3DComponentHost : CollisionShape3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CollisionShape3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CollisionShape3DComponentHost hostInstance);

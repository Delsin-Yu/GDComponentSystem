...
[Tool, GlobalClass]
public partial class ResourcePreloaderComponentHost : ResourcePreloader, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ResourcePreloaderComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ResourcePreloaderComponentHost hostInstance);

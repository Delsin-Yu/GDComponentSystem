...
/// <inheritdoc cref="HFlowContainer" />
[Tool, GlobalClass]
public partial class HFlowContainerComponentHost : HFlowContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HFlowContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HFlowContainerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class XRController3DComponentHost : XRController3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, XRController3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, XRController3DComponentHost hostInstance);

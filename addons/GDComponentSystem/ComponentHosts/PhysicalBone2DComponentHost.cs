...
[Tool, GlobalClass]
public partial class PhysicalBone2DComponentHost : PhysicalBone2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PhysicalBone2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PhysicalBone2DComponentHost hostInstance);
    ...
    public override void _IntegrateForces(PhysicsDirectBodyState2D @state)
    {
        ...
        {
            if (component is not RigidBody2DComponent typedComponent) continue;

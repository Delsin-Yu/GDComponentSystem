...
[Tool, GlobalClass]
public partial class ProgressBarComponentHost : ProgressBar, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ProgressBarComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ProgressBarComponentHost hostInstance);

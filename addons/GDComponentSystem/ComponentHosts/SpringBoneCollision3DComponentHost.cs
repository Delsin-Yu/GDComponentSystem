...
[Tool, GlobalClass]
public partial class SpringBoneCollision3DComponentHost : SpringBoneCollision3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SpringBoneCollision3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SpringBoneCollision3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class GraphNodeComponentHost : GraphNode, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GraphNodeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GraphNodeComponentHost hostInstance);
    ...
    public override void _DrawPort(int @slotIndex, Vector2I @position, bool @left, Color @color)
    {
        ...
        {
            if (component is not GraphNodeComponent typedComponent) continue;
            typedComponent._DrawPort(@slotIndex, @position, @left, @color);
        }
    }

...
[Tool, GlobalClass]
public partial class CharacterBody2DComponentHost : CharacterBody2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CharacterBody2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CharacterBody2DComponentHost hostInstance);

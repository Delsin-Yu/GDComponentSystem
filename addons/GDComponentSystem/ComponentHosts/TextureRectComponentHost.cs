...
[Tool, GlobalClass]
public partial class TextureRectComponentHost : TextureRect, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TextureRectComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TextureRectComponentHost hostInstance);

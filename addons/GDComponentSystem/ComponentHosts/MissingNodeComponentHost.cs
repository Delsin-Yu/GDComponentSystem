...
[Tool, GlobalClass]
public partial class MissingNodeComponentHost : MissingNode, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MissingNodeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MissingNodeComponentHost hostInstance);

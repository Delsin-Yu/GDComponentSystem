...
[Tool, GlobalClass]
public partial class ReferenceRectComponentHost : ReferenceRect, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ReferenceRectComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ReferenceRectComponentHost hostInstance);

...
/// <inheritdoc cref="Fabrik3D" />
[Tool, GlobalClass]
public partial class Fabrik3DComponentHost : Fabrik3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Fabrik3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Fabrik3DComponentHost hostInstance);

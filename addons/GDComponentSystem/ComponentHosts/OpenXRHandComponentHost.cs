...
[Tool, GlobalClass]
public partial class OpenXRHandComponentHost : OpenXRHand, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, OpenXRHandComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, OpenXRHandComponentHost hostInstance);

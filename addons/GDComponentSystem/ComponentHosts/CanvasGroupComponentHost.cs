...
[Tool, GlobalClass]
public partial class CanvasGroupComponentHost : CanvasGroup, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CanvasGroupComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CanvasGroupComponentHost hostInstance);

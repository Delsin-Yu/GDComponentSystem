...
[Tool, GlobalClass]
public partial class ParallaxLayerComponentHost : ParallaxLayer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ParallaxLayerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ParallaxLayerComponentHost hostInstance);

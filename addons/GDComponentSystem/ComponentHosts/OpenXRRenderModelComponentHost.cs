...
[Tool, GlobalClass]
public partial class OpenXRRenderModelComponentHost : OpenXRRenderModel, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, OpenXRRenderModelComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, OpenXRRenderModelComponentHost hostInstance);

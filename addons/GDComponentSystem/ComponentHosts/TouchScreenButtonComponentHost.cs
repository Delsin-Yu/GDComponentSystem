...
[Tool, GlobalClass]
public partial class TouchScreenButtonComponentHost : TouchScreenButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TouchScreenButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TouchScreenButtonComponentHost hostInstance);

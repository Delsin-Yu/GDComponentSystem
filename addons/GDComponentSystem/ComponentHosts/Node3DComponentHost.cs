...
[Tool, GlobalClass]
public partial class Node3DComponentHost : Node3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Node3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Node3DComponentHost hostInstance);

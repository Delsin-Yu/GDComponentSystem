...
[Tool, GlobalClass]
public partial class DirectionalLight2DComponentHost : DirectionalLight2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, DirectionalLight2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, DirectionalLight2DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class SubViewportContainerComponentHost : SubViewportContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SubViewportContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SubViewportContainerComponentHost hostInstance);
    ...
    public override bool _PropagateInputEvent(InputEvent @event)
    {
        ...
        {
            if (component is not SubViewportContainerComponent typedComponent) continue;
            return typedComponent._PropagateInputEvent(@event);
        }
        return base._PropagateInputEvent(@event);
    }
    ...
    public override int[] _GetAllowedSizeFlagsHorizontal()
    {
        foreach (var component in _components)
        {
            if (component is not ContainerComponent typedComponent) continue;
            return typedComponent._GetAllowedSizeFlagsHorizontal();
        }
        return base._GetAllowedSizeFlagsHorizontal();
    }
    ...
    public override int[] _GetAllowedSizeFlagsVertical()
    {
        ...
        {
            if (component is not ContainerComponent typedComponent) continue;
            return typedComponent._GetAllowedSizeFlagsVertical();
        }
        return base._GetAllowedSizeFlagsVertical();
    }

...
[Tool, GlobalClass]
public partial class TreeComponentHost : Tree, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TreeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TreeComponentHost hostInstance);

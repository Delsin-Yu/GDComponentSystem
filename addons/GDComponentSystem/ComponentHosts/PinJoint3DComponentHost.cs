...
[Tool, GlobalClass]
public partial class PinJoint3DComponentHost : PinJoint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PinJoint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PinJoint3DComponentHost hostInstance);

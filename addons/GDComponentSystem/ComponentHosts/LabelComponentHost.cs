...
[Tool, GlobalClass]
public partial class LabelComponentHost : Label, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, LabelComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, LabelComponentHost hostInstance);

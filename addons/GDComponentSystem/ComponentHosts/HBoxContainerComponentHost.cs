...
/// <inheritdoc cref="HBoxContainer" />
[Tool, GlobalClass]
public partial class HBoxContainerComponentHost : HBoxContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HBoxContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HBoxContainerComponentHost hostInstance);

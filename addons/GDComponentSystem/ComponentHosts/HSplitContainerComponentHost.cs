...
/// <inheritdoc cref="HSplitContainer" />
[Tool, GlobalClass]
public partial class HSplitContainerComponentHost : HSplitContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HSplitContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HSplitContainerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class VehicleBody3DComponentHost : VehicleBody3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VehicleBody3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VehicleBody3DComponentHost hostInstance);
    ...
    public override void _IntegrateForces(PhysicsDirectBodyState3D @state)
    {
        ...
        {
            if (component is not RigidBody3DComponent typedComponent) continue;

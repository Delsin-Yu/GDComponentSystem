...
[Tool, GlobalClass]
public partial class PhysicalBoneSimulator3DComponentHost : PhysicalBoneSimulator3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PhysicalBoneSimulator3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PhysicalBoneSimulator3DComponentHost hostInstance);

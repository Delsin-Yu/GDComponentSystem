...
[Tool, GlobalClass]
public partial class OccluderInstance3DComponentHost : OccluderInstance3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, OccluderInstance3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, OccluderInstance3DComponentHost hostInstance);

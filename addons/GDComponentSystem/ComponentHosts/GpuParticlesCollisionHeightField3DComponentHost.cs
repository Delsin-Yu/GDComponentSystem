...
[Tool, GlobalClass]
public partial class GpuParticlesCollisionHeightField3DComponentHost : GpuParticlesCollisionHeightField3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GpuParticlesCollisionHeightField3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GpuParticlesCollisionHeightField3DComponentHost hostInstance);

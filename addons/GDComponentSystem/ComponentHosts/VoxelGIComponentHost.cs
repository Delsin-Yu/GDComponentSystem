...
[Tool, GlobalClass]
public partial class VoxelGIComponentHost : VoxelGI, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VoxelGIComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VoxelGIComponentHost hostInstance);

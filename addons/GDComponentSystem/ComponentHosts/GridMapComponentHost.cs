...
[Tool, GlobalClass]
public partial class GridMapComponentHost : GridMap, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GridMapComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GridMapComponentHost hostInstance);

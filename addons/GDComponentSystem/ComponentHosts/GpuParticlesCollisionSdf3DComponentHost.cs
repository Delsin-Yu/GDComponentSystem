...
[Tool, GlobalClass]
public partial class GpuParticlesCollisionSdf3DComponentHost : GpuParticlesCollisionSdf3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GpuParticlesCollisionSdf3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GpuParticlesCollisionSdf3DComponentHost hostInstance);

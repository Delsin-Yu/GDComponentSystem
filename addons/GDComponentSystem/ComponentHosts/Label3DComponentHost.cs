...
[Tool, GlobalClass]
public partial class Label3DComponentHost : Label3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Label3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Label3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class NavigationRegion3DComponentHost : NavigationRegion3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationRegion3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationRegion3DComponentHost hostInstance);

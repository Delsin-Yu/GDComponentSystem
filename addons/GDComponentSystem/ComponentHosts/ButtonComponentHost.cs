...
[Tool, GlobalClass]
public partial class ButtonComponentHost : Button, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ButtonComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class MultiMeshInstance2DComponentHost : MultiMeshInstance2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MultiMeshInstance2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MultiMeshInstance2DComponentHost hostInstance);

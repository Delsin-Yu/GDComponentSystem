...
[Tool, GlobalClass]
public partial class AcceptDialogComponentHost : AcceptDialog, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AcceptDialogComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AcceptDialogComponentHost hostInstance);

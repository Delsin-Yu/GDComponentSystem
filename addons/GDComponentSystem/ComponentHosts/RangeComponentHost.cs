...
[Tool, GlobalClass]
public partial class RangeComponentHost : Range, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RangeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RangeComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class BoneConstraint3DComponentHost : BoneConstraint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, BoneConstraint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, BoneConstraint3DComponentHost hostInstance);

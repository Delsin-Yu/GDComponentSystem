...
[Tool, GlobalClass]
public partial class NinePatchRectComponentHost : NinePatchRect, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NinePatchRectComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NinePatchRectComponentHost hostInstance);

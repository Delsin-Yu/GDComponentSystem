...
[Tool, GlobalClass]
public partial class ScrollContainerComponentHost : ScrollContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ScrollContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ScrollContainerComponentHost hostInstance);

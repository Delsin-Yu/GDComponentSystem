...
[Tool, GlobalClass]
public partial class AudioStreamPlayerComponentHost : AudioStreamPlayer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AudioStreamPlayerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AudioStreamPlayerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class ItemListComponentHost : ItemList, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ItemListComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ItemListComponentHost hostInstance);

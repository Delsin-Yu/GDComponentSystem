...
[Tool, GlobalClass]
public partial class SubViewportComponentHost : SubViewport, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SubViewportComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SubViewportComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class LineEditComponentHost : LineEdit, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, LineEditComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, LineEditComponentHost hostInstance);

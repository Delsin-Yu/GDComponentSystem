...
[Tool, GlobalClass]
public partial class SpinBoxComponentHost : SpinBox, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SpinBoxComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SpinBoxComponentHost hostInstance);

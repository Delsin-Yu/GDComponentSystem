...
[Tool, GlobalClass]
public partial class FogVolumeComponentHost : FogVolume, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, FogVolumeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, FogVolumeComponentHost hostInstance);

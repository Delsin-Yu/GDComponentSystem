...
[Tool, GlobalClass]
public partial class Generic6DofJoint3DComponentHost : Generic6DofJoint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Generic6DofJoint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Generic6DofJoint3DComponentHost hostInstance);

...
/// <inheritdoc cref="HScrollBar" />
[Tool, GlobalClass]
public partial class HScrollBarComponentHost : HScrollBar, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HScrollBarComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HScrollBarComponentHost hostInstance);

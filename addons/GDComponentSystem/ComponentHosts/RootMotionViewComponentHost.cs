...
[Tool, GlobalClass]
public partial class RootMotionViewComponentHost : RootMotionView, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RootMotionViewComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RootMotionViewComponentHost hostInstance);

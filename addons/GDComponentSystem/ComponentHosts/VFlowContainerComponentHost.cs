...
/// <inheritdoc cref="VFlowContainer" />
[Tool, GlobalClass]
public partial class VFlowContainerComponentHost : VFlowContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VFlowContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VFlowContainerComponentHost hostInstance);

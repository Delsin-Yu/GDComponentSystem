...
[Tool, GlobalClass]
public partial class Skeleton3DComponentHost : Skeleton3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Skeleton3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Skeleton3DComponentHost hostInstance);

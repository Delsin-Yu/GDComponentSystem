...
[Tool, GlobalClass]
public partial class CollisionPolygon2DComponentHost : CollisionPolygon2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CollisionPolygon2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CollisionPolygon2DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class Camera2DComponentHost : Camera2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Camera2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Camera2DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class HingeJoint3DComponentHost : HingeJoint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HingeJoint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HingeJoint3DComponentHost hostInstance);

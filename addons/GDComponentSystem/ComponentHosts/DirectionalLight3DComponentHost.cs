...
[Tool, GlobalClass]
public partial class DirectionalLight3DComponentHost : DirectionalLight3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, DirectionalLight3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, DirectionalLight3DComponentHost hostInstance);

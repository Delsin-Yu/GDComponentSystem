...
[Tool, GlobalClass]
public partial class FoldableContainerComponentHost : FoldableContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, FoldableContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, FoldableContainerComponentHost hostInstance);

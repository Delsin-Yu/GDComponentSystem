...
[Tool, GlobalClass]
public partial class Parallax2DComponentHost : Parallax2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Parallax2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Parallax2DComponentHost hostInstance);

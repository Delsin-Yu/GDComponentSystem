...
[Tool, GlobalClass]
public partial class GraphFrameComponentHost : GraphFrame, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GraphFrameComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GraphFrameComponentHost hostInstance);

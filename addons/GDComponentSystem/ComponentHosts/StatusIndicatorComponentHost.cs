...
[Tool, GlobalClass]
public partial class StatusIndicatorComponentHost : StatusIndicator, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, StatusIndicatorComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, StatusIndicatorComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class AnimationTreeComponentHost : AnimationTree, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AnimationTreeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AnimationTreeComponentHost hostInstance);

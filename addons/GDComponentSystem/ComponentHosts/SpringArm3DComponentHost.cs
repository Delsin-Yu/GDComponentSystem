...
[Tool, GlobalClass]
public partial class SpringArm3DComponentHost : SpringArm3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SpringArm3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SpringArm3DComponentHost hostInstance);

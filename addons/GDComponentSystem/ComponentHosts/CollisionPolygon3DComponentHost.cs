...
[Tool, GlobalClass]
public partial class CollisionPolygon3DComponentHost : CollisionPolygon3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CollisionPolygon3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CollisionPolygon3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class AudioListener3DComponentHost : AudioListener3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AudioListener3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AudioListener3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class SoftBody3DComponentHost : SoftBody3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SoftBody3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SoftBody3DComponentHost hostInstance);

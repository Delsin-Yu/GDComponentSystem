...
[Tool, GlobalClass]
public partial class GraphElementComponentHost : GraphElement, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GraphElementComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GraphElementComponentHost hostInstance);

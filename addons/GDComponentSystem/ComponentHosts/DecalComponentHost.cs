...
[Tool, GlobalClass]
public partial class DecalComponentHost : Decal, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, DecalComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, DecalComponentHost hostInstance);

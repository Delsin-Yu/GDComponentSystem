...
[Tool, GlobalClass]
public partial class Area2DComponentHost : Area2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Area2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Area2DComponentHost hostInstance);

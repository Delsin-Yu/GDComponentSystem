...
[Tool, GlobalClass]
public partial class XROrigin3DComponentHost : XROrigin3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, XROrigin3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, XROrigin3DComponentHost hostInstance);

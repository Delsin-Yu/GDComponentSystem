...
[Tool, GlobalClass]
public partial class CsgTorus3DComponentHost : CsgTorus3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CsgTorus3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CsgTorus3DComponentHost hostInstance);

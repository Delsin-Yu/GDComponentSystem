...
[Tool, GlobalClass]
public partial class RemoteTransform2DComponentHost : RemoteTransform2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RemoteTransform2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RemoteTransform2DComponentHost hostInstance);

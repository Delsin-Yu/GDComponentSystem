...
/// <inheritdoc cref="OpenXRVisibilityMask" />
[Tool, GlobalClass]
public partial class OpenXRVisibilityMaskComponentHost : OpenXRVisibilityMask, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, OpenXRVisibilityMaskComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, OpenXRVisibilityMaskComponentHost hostInstance);

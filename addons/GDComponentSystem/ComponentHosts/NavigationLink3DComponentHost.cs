...
[Tool, GlobalClass]
public partial class NavigationLink3DComponentHost : NavigationLink3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationLink3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationLink3DComponentHost hostInstance);

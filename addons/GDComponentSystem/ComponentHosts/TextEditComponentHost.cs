...
[Tool, GlobalClass]
public partial class TextEditComponentHost : TextEdit, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TextEditComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TextEditComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class ColorPickerButtonComponentHost : ColorPickerButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ColorPickerButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ColorPickerButtonComponentHost hostInstance);

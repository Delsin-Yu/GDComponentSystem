...
[Tool, GlobalClass]
public partial class PhysicalBone3DComponentHost : PhysicalBone3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PhysicalBone3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PhysicalBone3DComponentHost hostInstance);
    ...
    public override void _IntegrateForces(PhysicsDirectBodyState3D @state)
    {
        ...
        {
            if (component is not PhysicalBone3DComponent typedComponent) continue;
            typedComponent._IntegrateForces(@state);
        }
    }

...
[Tool, GlobalClass]
public partial class PopupComponentHost : Popup, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PopupComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PopupComponentHost hostInstance);

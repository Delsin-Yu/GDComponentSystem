...
[Tool, GlobalClass]
public partial class GeometryInstance3DComponentHost : GeometryInstance3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GeometryInstance3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GeometryInstance3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class XRAnchor3DComponentHost : XRAnchor3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, XRAnchor3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, XRAnchor3DComponentHost hostInstance);

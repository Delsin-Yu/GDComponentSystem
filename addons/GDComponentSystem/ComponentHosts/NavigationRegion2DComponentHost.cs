...
[Tool, GlobalClass]
public partial class NavigationRegion2DComponentHost : NavigationRegion2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationRegion2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationRegion2DComponentHost hostInstance);

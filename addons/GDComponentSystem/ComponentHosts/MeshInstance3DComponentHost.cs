...
[Tool, GlobalClass]
public partial class MeshInstance3DComponentHost : MeshInstance3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MeshInstance3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MeshInstance3DComponentHost hostInstance);

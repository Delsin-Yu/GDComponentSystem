...
[Tool, GlobalClass]
public partial class PointLight2DComponentHost : PointLight2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PointLight2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PointLight2DComponentHost hostInstance);

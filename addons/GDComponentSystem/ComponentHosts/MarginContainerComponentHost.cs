...
/// <inheritdoc cref="MarginContainer" />
[Tool, GlobalClass]
public partial class MarginContainerComponentHost : MarginContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MarginContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MarginContainerComponentHost hostInstance);

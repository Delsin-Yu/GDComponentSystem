...
[Tool, GlobalClass]
public partial class VehicleWheel3DComponentHost : VehicleWheel3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VehicleWheel3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VehicleWheel3DComponentHost hostInstance);

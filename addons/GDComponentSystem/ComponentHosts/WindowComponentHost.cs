...
[Tool, GlobalClass]
public partial class WindowComponentHost : Window, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, WindowComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, WindowComponentHost hostInstance);

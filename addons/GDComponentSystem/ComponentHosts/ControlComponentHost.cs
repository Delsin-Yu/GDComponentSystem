...
[Tool, GlobalClass]
public partial class ControlComponentHost : Control, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ControlComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ControlComponentHost hostInstance);

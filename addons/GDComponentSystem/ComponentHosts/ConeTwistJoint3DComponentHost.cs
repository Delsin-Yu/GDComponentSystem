...
[Tool, GlobalClass]
public partial class ConeTwistJoint3DComponentHost : ConeTwistJoint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ConeTwistJoint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ConeTwistJoint3DComponentHost hostInstance);

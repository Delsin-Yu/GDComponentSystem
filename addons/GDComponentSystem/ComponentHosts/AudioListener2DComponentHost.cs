...
[Tool, GlobalClass]
public partial class AudioListener2DComponentHost : AudioListener2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AudioListener2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AudioListener2DComponentHost hostInstance);

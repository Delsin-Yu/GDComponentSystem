...
/// <inheritdoc cref="PopupPanel" />
[Tool, GlobalClass]
public partial class PopupPanelComponentHost : PopupPanel, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PopupPanelComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PopupPanelComponentHost hostInstance);

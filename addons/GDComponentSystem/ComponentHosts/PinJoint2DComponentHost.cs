...
[Tool, GlobalClass]
public partial class PinJoint2DComponentHost : PinJoint2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PinJoint2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PinJoint2DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class ContainerComponentHost : Container, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ContainerComponentHost hostInstance);

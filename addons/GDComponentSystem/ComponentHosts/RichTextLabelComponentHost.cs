...
[Tool, GlobalClass]
public partial class RichTextLabelComponentHost : RichTextLabel, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RichTextLabelComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RichTextLabelComponentHost hostInstance);

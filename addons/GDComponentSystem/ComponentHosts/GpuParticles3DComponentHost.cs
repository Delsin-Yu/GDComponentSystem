...
[Tool, GlobalClass]
public partial class GpuParticles3DComponentHost : GpuParticles3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GpuParticles3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GpuParticles3DComponentHost hostInstance);

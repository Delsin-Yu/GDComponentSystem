...
[Tool, GlobalClass]
public partial class BaseButtonComponentHost : BaseButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, BaseButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, BaseButtonComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class HttpRequestComponentHost : HttpRequest, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HttpRequestComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HttpRequestComponentHost hostInstance);

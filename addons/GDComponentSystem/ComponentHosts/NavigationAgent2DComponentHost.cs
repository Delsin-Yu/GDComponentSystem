...
[Tool, GlobalClass]
public partial class NavigationAgent2DComponentHost : NavigationAgent2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationAgent2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationAgent2DComponentHost hostInstance);

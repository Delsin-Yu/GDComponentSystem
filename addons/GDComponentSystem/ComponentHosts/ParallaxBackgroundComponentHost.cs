...
[Tool, GlobalClass]
public partial class ParallaxBackgroundComponentHost : ParallaxBackground, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ParallaxBackgroundComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ParallaxBackgroundComponentHost hostInstance);

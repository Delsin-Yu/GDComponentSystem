...
[Tool, GlobalClass]
public partial class XRNode3DComponentHost : XRNode3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, XRNode3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, XRNode3DComponentHost hostInstance);

...
/// <inheritdoc cref="HSeparator" />
[Tool, GlobalClass]
public partial class HSeparatorComponentHost : HSeparator, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HSeparatorComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HSeparatorComponentHost hostInstance);

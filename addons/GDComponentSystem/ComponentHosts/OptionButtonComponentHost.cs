...
[Tool, GlobalClass]
public partial class OptionButtonComponentHost : OptionButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, OptionButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, OptionButtonComponentHost hostInstance);

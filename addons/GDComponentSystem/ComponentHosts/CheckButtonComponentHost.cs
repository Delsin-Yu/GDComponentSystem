...
/// <inheritdoc cref="CheckButton" />
[Tool, GlobalClass]
public partial class CheckButtonComponentHost : CheckButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CheckButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CheckButtonComponentHost hostInstance);
    ...
    public override void _Pressed()
    {
        ...
        {
            if (component is not BaseButtonComponent typedComponent) continue;
            typedComponent._Pressed();
        }
    }
    ...
    public override void _Toggled(bool @toggledOn)
    {
        ...
        {
            if (component is not BaseButtonComponent typedComponent) continue;
            typedComponent._Toggled(@toggledOn);
        }
    }

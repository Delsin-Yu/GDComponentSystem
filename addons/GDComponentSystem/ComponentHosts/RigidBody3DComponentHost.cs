...
[Tool, GlobalClass]
public partial class RigidBody3DComponentHost : RigidBody3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RigidBody3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RigidBody3DComponentHost hostInstance);

...
/// <inheritdoc cref="ShaderGlobalsOverride" />
[Tool, GlobalClass]
public partial class ShaderGlobalsOverrideComponentHost : ShaderGlobalsOverride, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ShaderGlobalsOverrideComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ShaderGlobalsOverrideComponentHost hostInstance);

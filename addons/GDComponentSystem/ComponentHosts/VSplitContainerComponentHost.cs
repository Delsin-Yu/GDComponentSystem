...
/// <inheritdoc cref="VSplitContainer" />
[Tool, GlobalClass]
public partial class VSplitContainerComponentHost : VSplitContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VSplitContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VSplitContainerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class TabBarComponentHost : TabBar, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TabBarComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TabBarComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class LinkButtonComponentHost : LinkButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, LinkButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, LinkButtonComponentHost hostInstance);

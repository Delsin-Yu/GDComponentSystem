...
[Tool, GlobalClass]
public partial class LightOccluder2DComponentHost : LightOccluder2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, LightOccluder2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, LightOccluder2DComponentHost hostInstance);

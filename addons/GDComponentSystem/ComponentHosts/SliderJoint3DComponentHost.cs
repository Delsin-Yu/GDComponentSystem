...
[Tool, GlobalClass]
public partial class SliderJoint3DComponentHost : SliderJoint3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SliderJoint3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SliderJoint3DComponentHost hostInstance);

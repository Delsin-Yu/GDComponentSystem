...
[Tool, GlobalClass]
public partial class StaticBody2DComponentHost : StaticBody2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, StaticBody2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, StaticBody2DComponentHost hostInstance);

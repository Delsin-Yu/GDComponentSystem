...
[Tool, GlobalClass]
public partial class ColorRectComponentHost : ColorRect, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ColorRectComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ColorRectComponentHost hostInstance);

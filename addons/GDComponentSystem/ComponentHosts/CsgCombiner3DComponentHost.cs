...
/// <inheritdoc cref="CsgCombiner3D" />
[Tool, GlobalClass]
public partial class CsgCombiner3DComponentHost : CsgCombiner3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CsgCombiner3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CsgCombiner3DComponentHost hostInstance);

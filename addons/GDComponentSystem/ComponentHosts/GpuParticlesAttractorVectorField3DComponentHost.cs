...
[Tool, GlobalClass]
public partial class GpuParticlesAttractorVectorField3DComponentHost : GpuParticlesAttractorVectorField3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GpuParticlesAttractorVectorField3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GpuParticlesAttractorVectorField3DComponentHost hostInstance);
    ...
    public override Aabb _GetAabb()
    {
        ...
        {
            if (component is not VisualInstance3DComponent typedComponent) continue;
            return typedComponent._GetAabb();
        }

...
/// <inheritdoc cref="SpringBoneCollisionPlane3D" />
[Tool, GlobalClass]
public partial class SpringBoneCollisionPlane3DComponentHost : SpringBoneCollisionPlane3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, SpringBoneCollisionPlane3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, SpringBoneCollisionPlane3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class TextureProgressBarComponentHost : TextureProgressBar, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TextureProgressBarComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TextureProgressBarComponentHost hostInstance);

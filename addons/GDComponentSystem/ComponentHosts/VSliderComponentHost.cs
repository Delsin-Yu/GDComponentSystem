...
/// <inheritdoc cref="VSlider" />
[Tool, GlobalClass]
public partial class VSliderComponentHost : VSlider, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VSliderComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VSliderComponentHost hostInstance);

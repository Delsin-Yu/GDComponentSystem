...
/// <inheritdoc cref="VBoxContainer" />
[Tool, GlobalClass]
public partial class VBoxContainerComponentHost : VBoxContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VBoxContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VBoxContainerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class MultiMeshInstance3DComponentHost : MultiMeshInstance3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MultiMeshInstance3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MultiMeshInstance3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class AnimatedSprite3DComponentHost : AnimatedSprite3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AnimatedSprite3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AnimatedSprite3DComponentHost hostInstance);

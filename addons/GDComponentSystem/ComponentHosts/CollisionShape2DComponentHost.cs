...
[Tool, GlobalClass]
public partial class CollisionShape2DComponentHost : CollisionShape2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CollisionShape2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CollisionShape2DComponentHost hostInstance);

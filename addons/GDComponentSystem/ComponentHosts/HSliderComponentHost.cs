...
/// <inheritdoc cref="HSlider" />
[Tool, GlobalClass]
public partial class HSliderComponentHost : HSlider, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, HSliderComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, HSliderComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class RemoteTransform3DComponentHost : RemoteTransform3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RemoteTransform3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RemoteTransform3DComponentHost hostInstance);

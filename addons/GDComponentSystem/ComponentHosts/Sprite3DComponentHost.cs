...
[Tool, GlobalClass]
public partial class Sprite3DComponentHost : Sprite3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Sprite3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Sprite3DComponentHost hostInstance);

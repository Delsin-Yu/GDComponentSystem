...
[Tool, GlobalClass]
public partial class CheckBoxComponentHost : CheckBox, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CheckBoxComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CheckBoxComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class TextureButtonComponentHost : TextureButton, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, TextureButtonComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, TextureButtonComponentHost hostInstance);

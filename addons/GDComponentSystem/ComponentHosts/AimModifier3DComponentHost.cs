...
[Tool, GlobalClass]
public partial class AimModifier3DComponentHost : AimModifier3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AimModifier3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AimModifier3DComponentHost hostInstance);

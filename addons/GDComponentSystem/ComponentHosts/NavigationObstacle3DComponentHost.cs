...
[Tool, GlobalClass]
public partial class NavigationObstacle3DComponentHost : NavigationObstacle3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationObstacle3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationObstacle3DComponentHost hostInstance);

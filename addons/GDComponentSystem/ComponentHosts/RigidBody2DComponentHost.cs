...
[Tool, GlobalClass]
public partial class RigidBody2DComponentHost : RigidBody2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RigidBody2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RigidBody2DComponentHost hostInstance);

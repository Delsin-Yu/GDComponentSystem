...
[Tool, GlobalClass]
public partial class RayCast3DComponentHost : RayCast3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, RayCast3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, RayCast3DComponentHost hostInstance);

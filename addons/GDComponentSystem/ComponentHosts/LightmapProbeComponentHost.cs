...
/// <inheritdoc cref="LightmapProbe" />
[Tool, GlobalClass]
public partial class LightmapProbeComponentHost : LightmapProbe, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, LightmapProbeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, LightmapProbeComponentHost hostInstance);

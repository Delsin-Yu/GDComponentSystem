...
[Tool, GlobalClass]
public partial class NavigationObstacle2DComponentHost : NavigationObstacle2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationObstacle2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationObstacle2DComponentHost hostInstance);

...
/// <inheritdoc cref="PanelContainer" />
[Tool, GlobalClass]
public partial class PanelContainerComponentHost : PanelContainer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PanelContainerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PanelContainerComponentHost hostInstance);

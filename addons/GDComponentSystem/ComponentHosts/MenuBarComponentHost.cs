...
[Tool, GlobalClass]
public partial class MenuBarComponentHost : MenuBar, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MenuBarComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MenuBarComponentHost hostInstance);

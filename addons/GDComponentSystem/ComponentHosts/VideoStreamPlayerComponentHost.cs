...
[Tool, GlobalClass]
public partial class VideoStreamPlayerComponentHost : VideoStreamPlayer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VideoStreamPlayerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VideoStreamPlayerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class MeshInstance2DComponentHost : MeshInstance2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MeshInstance2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MeshInstance2DComponentHost hostInstance);

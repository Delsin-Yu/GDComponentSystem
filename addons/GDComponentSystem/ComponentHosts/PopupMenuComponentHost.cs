...
[Tool, GlobalClass]
public partial class PopupMenuComponentHost : PopupMenu, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PopupMenuComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PopupMenuComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class AudioStreamPlayer3DComponentHost : AudioStreamPlayer3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AudioStreamPlayer3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AudioStreamPlayer3DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class DampedSpringJoint2DComponentHost : DampedSpringJoint2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, DampedSpringJoint2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, DampedSpringJoint2DComponentHost hostInstance);

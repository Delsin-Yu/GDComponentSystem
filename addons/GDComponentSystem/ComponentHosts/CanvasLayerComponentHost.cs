...
[Tool, GlobalClass]
public partial class CanvasLayerComponentHost : CanvasLayer, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CanvasLayerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CanvasLayerComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class CsgMesh3DComponentHost : CsgMesh3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CsgMesh3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CsgMesh3DComponentHost hostInstance);

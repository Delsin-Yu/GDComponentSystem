...
[Tool, GlobalClass]
public partial class AnimatedSprite2DComponentHost : AnimatedSprite2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, AnimatedSprite2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, AnimatedSprite2DComponentHost hostInstance);

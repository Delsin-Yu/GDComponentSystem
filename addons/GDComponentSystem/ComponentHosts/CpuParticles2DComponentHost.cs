...
[Tool, GlobalClass]
public partial class CpuParticles2DComponentHost : CpuParticles2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CpuParticles2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CpuParticles2DComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class CanvasModulateComponentHost : CanvasModulate, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CanvasModulateComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CanvasModulateComponentHost hostInstance);

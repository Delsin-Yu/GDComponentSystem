...
[Tool, GlobalClass]
public partial class CsgCylinder3DComponentHost : CsgCylinder3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CsgCylinder3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CsgCylinder3DComponentHost hostInstance);

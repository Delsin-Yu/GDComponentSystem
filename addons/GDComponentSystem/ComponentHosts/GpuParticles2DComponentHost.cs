...
[Tool, GlobalClass]
public partial class GpuParticles2DComponentHost : GpuParticles2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, GpuParticles2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, GpuParticles2DComponentHost hostInstance);

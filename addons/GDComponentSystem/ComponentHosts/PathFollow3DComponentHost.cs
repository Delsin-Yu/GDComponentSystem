...
[Tool, GlobalClass]
public partial class PathFollow3DComponentHost : PathFollow3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PathFollow3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PathFollow3DComponentHost hostInstance);

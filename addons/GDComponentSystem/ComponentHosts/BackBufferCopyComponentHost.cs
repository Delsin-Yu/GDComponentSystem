...
[Tool, GlobalClass]
public partial class BackBufferCopyComponentHost : BackBufferCopy, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, BackBufferCopyComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, BackBufferCopyComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class WorldEnvironmentComponentHost : WorldEnvironment, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, WorldEnvironmentComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, WorldEnvironmentComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class FileDialogComponentHost : FileDialog, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, FileDialogComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, FileDialogComponentHost hostInstance);

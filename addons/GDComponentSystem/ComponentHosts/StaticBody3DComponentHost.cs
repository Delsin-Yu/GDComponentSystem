...
[Tool, GlobalClass]
public partial class StaticBody3DComponentHost : StaticBody3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, StaticBody3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, StaticBody3DComponentHost hostInstance);

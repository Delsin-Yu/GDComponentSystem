...
[Tool, GlobalClass]
public partial class Sprite2DComponentHost : Sprite2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Sprite2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Sprite2DComponentHost hostInstance);

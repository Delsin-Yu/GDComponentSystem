...
[Tool, GlobalClass]
public partial class Polygon2DComponentHost : Polygon2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, Polygon2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, Polygon2DComponentHost hostInstance);

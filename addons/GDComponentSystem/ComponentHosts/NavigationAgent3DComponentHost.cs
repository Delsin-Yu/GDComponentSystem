...
[Tool, GlobalClass]
public partial class NavigationAgent3DComponentHost : NavigationAgent3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, NavigationAgent3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, NavigationAgent3DComponentHost hostInstance);

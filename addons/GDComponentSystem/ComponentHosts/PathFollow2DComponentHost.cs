...
[Tool, GlobalClass]
public partial class PathFollow2DComponentHost : PathFollow2D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, PathFollow2DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, PathFollow2DComponentHost hostInstance);

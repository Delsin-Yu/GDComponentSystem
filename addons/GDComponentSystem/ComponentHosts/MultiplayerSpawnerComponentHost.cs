...
[Tool, GlobalClass]
public partial class MultiplayerSpawnerComponentHost : MultiplayerSpawner, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, MultiplayerSpawnerComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, MultiplayerSpawnerComponentHost hostInstance);

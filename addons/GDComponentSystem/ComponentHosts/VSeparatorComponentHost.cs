...
/// <inheritdoc cref="VSeparator" />
[Tool, GlobalClass]
public partial class VSeparatorComponentHost : VSeparator, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, VSeparatorComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, VSeparatorComponentHost hostInstance);

...
[Tool, GlobalClass]
public partial class CsgBox3DComponentHost : CsgBox3D, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, CsgBox3DComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, CsgBox3DComponentHost hostInstance);

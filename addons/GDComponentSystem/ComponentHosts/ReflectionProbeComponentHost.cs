...
[Tool, GlobalClass]
public partial class ReflectionProbeComponentHost : ReflectionProbe, IComponentHost
{
    ...
    private static extern void OnComponentAdded(NodeComponent nodeComponent, ReflectionProbeComponentHost hostInstance);

    [UnsafeAccessor(UnsafeAccessorKind.Method, Name = "_OnComponentRemoved")]
    private static extern void OnComponentRemoved(NodeComponent nodeComponent, ReflectionProbeComponentHost hostInstance);
